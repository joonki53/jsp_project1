...
<html lang="ko">
  ...
  <head>
   ...
   <!-- //구글폰트 -->
    ...
    <title>HJK GAMES &copy; modi page</title>
...
<div class="container">	
	...
	<form  action="modi_ok.jsp?bbsID=<%= bbsID %>"   method="post">
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2" class="editor"><textarea   rows="20" name="bbsContent" maxlength="2048"  ><%= bbs.getBbsContent() %></textarea></td>
	...
	<div class="border_btn2">
		...
		<%
				...
				%>
						...
						<a href = "bbs.jsp" class="btn gray">목록</a>
