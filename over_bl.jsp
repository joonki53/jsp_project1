...
<%
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="img/page-top-bg/11.jpg">
		<div class="pi-content">
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>OVERWATCH BLOG</h2>
						<p>this page is a overwatch blog page , freely share and talking about information for game</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="page-section single-blog-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-thumb set-bg" data-setbg="img/recent-game/12.jpg">
					...
					<div class="blog-content">
						<h3>OVERWATCH information</h3>
						<a href="" class="meta-comment">3 comment</a>
						<p>
							개발 : Blizzard<br>
							장르 : 히어로 슈팅<br>
							플랫폼 : Windows, PS4, XBOX ONE, Nintendo Switch<br>
							출시 : 	Windows, PS4, XBOX ONE : 
									2016년 5월 24일<br>
									Nintendo Switch : 2019년 10월 16일
						</p>
						<p>
						미국의 블리자드 엔터테인먼트에서 제작한 팀 기반 멀티플레이 하이퍼 FPS 게임이다.
						2015년 10월 27일에 클로즈 베타로 플레이 가능한 형태로 공개되었으며, 2016년 5월 24일에 PC, PS4, Xbox One으로 전 세계에 발매되었고, 2022년 10월 4일 오전 1시 경 오버워치 2 서비스를 출시하기 위한 패치와 점검을 위해 서비스가 종료되었으며, 이후 10월 5일에 오버워치 2로 서비스가 이전되었다.
						2019년 10월 15일에 닌텐도 스위치 버전이 출시되었다.
						</p>
					</div>
					...
					<div class="comment-form-warp">
						...
						<form class="comment-form" method="post" action="write_ok.jsp">
							<div class="row">
								...
								<div class="col-md-6">
									<input type="email" value="OverWatch" readonly name="bbsGame">
								</div>
								<div class="col-lg-12">
